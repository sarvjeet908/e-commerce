...
public class FakeStoreproductService implements IProductService{
    ...
    public Product getProductfromresponseDto(ProductresponseDto productresponseDto){
              ...
              product.setDescription(productresponseDto.getDesc());
...
//              product.getCategory().setName(productresponseDto.getCategory());
    ...
    public Product getSingleProduct(Long id) throws InvalidProductIdException {
        ...
        if(id>20){
                throw new InvalidProductIdException("product with "+id+" not exist. ");
        }
    ...
    public List<ProductresponseDto> getAllproducts() {
        //since by looking into fakestore getall product response we got to
        // know it's returning Array of Product response dto
        //that's why created Array with FakeStoreProduct type
        //lets check if it is showing in git

        FakeStoreProduct[] responsedtolist =
                restTemplate.getForObject
                        ("https://fakestoreapi.com/products", FakeStoreProduct[].class);
...
/*        //this is not returning anything but i want updated version
    ...
    @Override
    public Product updateProductTo(Long id, Product product) {
        return null;
    }
